...
from GRAPH.GraphMeasureTransform import GlobalGraphMeasureTransform
...
GlobalMeasures = GlobalGraphMeasureTransform(global_efficiency=1, global_reaching_centrality=1, graph_clique_number=1)
