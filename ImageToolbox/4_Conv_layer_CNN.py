...
class SimpleCNN(BaseEstimator, ClassifierMixin, KerasBaseEstimator):
    ...
    def __init__(self, hidden_layer_sizes=[128, 128],
                 ...
                 third_layer_dim=16, third_layer_kernel=2,
                 third_layer_activation='relu', third_layer_batchnorm=1,
                 third_layer_pooling=0, third_layer_poolsize=2,
                 fourth_layer_dim = 20, fourth_layer_kernel = 2,
                 fourth_layer_activation = 'relu', fourth_layer_batchnorm=1,
                 fourth_layer_pooling = 1, fourth_layer_poolsize = 2,
        ...
        # third layer hyperparameters
        self.third_layer_dim = third_layer_dim
        self.third_layer_kernel = third_layer_kernel
        self.third_layer_activation = third_layer_activation
        self.third_layer_batchnorm = third_layer_batchnorm
        self.third_layer_pooling = third_layer_pooling
        self.third_layer_poolsize = third_layer_poolsize

        # fourth layer hyperparameters
        self.fourth_layer_dim = fourth_layer_dim
        self.fourth_layer_kernel = fourth_layer_kernel
        self.fourth_layer_activation = fourth_layer_activation
        self.fourth_layer_batchnorm = fourth_layer_batchnorm
        self.fourth_layer_pooling = fourth_layer_pooling
        self.fourth_layer_poolsize = fourth_layer_poolsize
    ...
    def create_model(self, input_size):
        ...
        # constructing the third convlayer
        model.add(Conv2D(self.third_layer_dim,
                         kernel_size=(self.third_layer_dim, self.third_layer_dim),
                         activation=self.third_layer_activation))
        if self.third_layer_batchnorm == 1:
            model.add(BatchNormalization())
        if self.third_layer_pooling == 1:
            model.add(MaxPooling2D(pool_size=self.third_layer_poolsize))
